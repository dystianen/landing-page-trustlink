                ...
                <div className={'w-full flex justify-center mb-10'} >
                    <div className={'montserrat'}>
                        <div className={'flex flex-row justify-center items-center'}>
                            ...
                            <h6 className={'text-sm mx-2 sm:mx-6 text-[#818FA6] montserrat mb-0 text-center font-normal'}>{t('Let us Know')}</h6>
                            <div className={'w-10 sm:w-16 h-[2px] bg-[#818FA6] opacity-50'}/>
                        </div>
                        <div className={'flex flex-row items-end'}>
                            <h1 className={'text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold mb-0 text-[#04204D] mr-4 sm:mr-8'}>{t('Intouch')}</h1>
                            <h2 className={'text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#04204D] mb-0 font-medium'}>{t('Ask Anything')}</h2>
                        </div>
                    </div>
                </div>
