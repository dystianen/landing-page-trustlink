            ...
            <div className={'w-full mt-20 sm:mt-10 mr-10 flex justify-end section-most-top'} ref={sectionRef}>
                <div className={'w-full sm:w-[100vw]'}>
                        ...
                        <div style={{whiteSpace: 'pre-line'}} className={'flex justify-center'}>
                            ...
                            <Text className={'text-[#04204D] w-full md:w-[48rem] lg:w-[60rem] xl:w-[64rem] 2xl:w-[72rem] sm:pl-10 lg:pl-20 xl:pl-8 2xl:pl-12 md:px-8 lg:px-4 sm:pr-10 sm:mt-10 xl:mt-6 text-base lg:text-lg sm:flex montserrat font-normal md:tracking-tight lg:tracking-normal'}>
