...
export const UseCases = observer(({show, setShow}) => {
    ...
    const dataUseCases = [
        {
            key: 'sclaw',
            title: t('Security and laws'),
            description: t('Desc security and laws'),
        ...
        },
        {
            key: 'bank',
            title: t('Your Bank'),
            description: t('Desc your bank'),
            left: '/assets/logo/trust/connect.png',
            right: '/assets/logo/trust/score.png',
        },
        {
            key: 'user',
            title: t('Interactive Scanning'),
            description: t('Desc interactive scanning'),
