    ...
    return (
        <Drawer title={null} placement="left" onClose={() => {}} closable={false} visible={isOpen} contentWrapperStyle={{width: '100%'}} bodyStyle={{padding: 0}}>
            <div className={'w-screen h-full flex flex-row'}>
                ...
                <div className={'flex flex-col justify-center items-center w-112 h-full p-11'}>
                    {
                        menu.map((it, index) => (
                ...
                <div className={'w-screen h-full py-56'} style={{backgroundColor: '#1D365F'}}>
                    <div className={'flex flex-col w-full h-full justify-between'}>
                        ...
                        <div className={'flex flex-row justify-around'}>
                            ...
                            <div className={'flex w-20 h-20 opacity-0'} />
                        </div>
                    </div>
                </div>
            </div>
