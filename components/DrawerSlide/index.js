                    ...
                    <div className={'flex flex-col w-full h-full justify-between'}>
                        ...
                        <div className={'flex flex-row w-full justify-start'}>
                            <div className={'w-full md:w-auto mb-12 md:mb-0'}>
                                <h1 className={`text-white text-xl  ${(showProduct || showUseCase) ? 'md:text-xl' : 'md:text-2xl'} font-bold mb-3 montserrat`}>{t('The Most Advance')} <br/> <span className={'font-light'}>{t('End to End')}</span> <br/>{t('Digital Biometric')} <br/> {t('Solution Provider')}</h1>
                            </div>
                        </div>
                    </div>
                </div>
