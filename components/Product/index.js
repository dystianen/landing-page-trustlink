    ...
    let items = [
        {
            ...
            name2: 'Verify',
            coming_soon : '',
            src: isSafari || isIos ? '/assets/product/bg-white/TrustVerify.mp4' : '/assets/product/revision-new/TrustVerify.webm',
            ...
            width_desc: 'w-[19.5rem] md:w-[22rem] lg:w-[32rem] xl:w-[39rem] tracking-tighter'
        },
        {
            name: 'Trust',
            name2: 'Scan',
            coming_soon : '',
            src: isSafari || isIos ? '/assets/product/bg-white/TrustScan.mp4' : '/assets/product/revision-new/TrustScan.webm',
            subhead: t('trust_scan_title'),
            desc: t('trust_scan_subtitle'),
            size: md ? '100%' : xs ? '50%' : '80%',
            width_subhead: 'w-[17rem] md:w-[15rem] lg:w-[18rem] xl:w-auto',
            width_desc: 'w-[19rem] md:w-[20.5rem] lg:w-[30.1rem] xl:w-[38.9rem] 2xl:w-[41.5rem] tracking-tighter md:tracking-normal lg:tracking-tighter'
        },

        {
            ...
            name2: 'Live',
            coming_soon : '',
            src: isSafari || isIos ? '/assets/product/bg-white/TrustLive-short.mp4' : '/assets/product/revision-new/TrustLive.webm',
                            ...
                            <Step
                                ...
                                icon={
                                    <div className={`flex flex-col justify-center items-start sm:items-center ${current === index ? 'mt-2 lg:mt-0' : 'mt-12 sm:mt-10 lg:mt-12'}`}>
                                        <div id={`click-header-products-trust-${it.name}`} className={`click-header-products-trust-${it.name} p-0 ${index === (data.length - 1) ? `sm:ml-[16px]` : ``} rounded-full border-4 ${current === index ? `w-14 h-14 sm:w-[4.75rem] lg:w-24 sm:h-[4.75rem] lg:h-24 border-[#FF6703]` : `w-12 h-12 sm:w-16 lg:w-20 sm:h-16 lg:h-20 border-[#FF6703]`} mb-2 bg-white z-10 flex justify-center items-center`}
                                             style={{transition: 'width 200ms, height 200ms', boxShadow: current === index ? `0 0 ${shadow}px 1px #FE6601` : null}}
                                        >
                                            <Tooltip title={'Trust' +it.name} className={`click-header-products-trust-${it.name}`}>
