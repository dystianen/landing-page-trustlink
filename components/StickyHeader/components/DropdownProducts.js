        ...
        return menu === 2 ? ( <>
                <Fade cascade bottom duration={1000}>
                    <div className="h-full w-2/6 rounded-l-3xl flex flex-col px-10 py-9 justify-between montserrat text-[16px] font-medium">
                        <Text className={'cursor-pointer'} onClick={() => router.push('/id/product')}>OCR</Text>
                        <Text className={'cursor-pointer'} onClick={() => router.push('/id/product/transaction-history')}>Transaction History</Text>
                        <Text className={'cursor-pointer'} onClick={() => router.push('/id/product/e-commerce-and-e-wallet-data')}>E-Commerce and E-Wallet Data</Text>
                    </div>
                    <div className="h-full w-2/6 rounded-l-3xl flex flex-col px-10 py-9 justify-start montserrat text-[16px] font-medium">
                        <Text className={'cursor-pointer'} onClick={() => router.push('/id/product/income-and-employment-verification')}>Income and Employment Verification</Text>
                    </div>
                </Fade>
                </>
            ) : menu === 1 && (
            <Fade cascade bottom duration={1000}>
                <div className="h-full w-2/6 rounded-l-3xl flex flex-col px-10 py-9 justify-between montserrat text-[16px] font-medium">
                    <Text className={'cursor-pointer'} onClick={() => router.push('/id/product')}>OCR</Text>
                    <Text className={'cursor-pointer'} onClick={() => router.push('/id/product/passive-liveness')}>Passive Liveness</Text>
                    <Text className={'cursor-pointer'} onClick={() => router.push('/id/product/digital-signature')}>Digital Signature with e-KYC</Text>
                </div>
            </Fade>
        )
    }
