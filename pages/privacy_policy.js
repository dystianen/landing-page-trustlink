...
1.\tYour Provider will direct you to use our Services which will include the following: 
    1.1 \tWe will provide you with a software tool **(“Tool”)** which you can use to transmit information (including personal data) relating to payment accounts **(“Account Information”)** that you hold with Data Providers to your Provider, and for Payment Initiation, which you can use to consent to and authorize a payment as specified by your Provider; this may require that your Provider sends us your bank account details
    1.2 To use our Services you may need to provide the same identifying information that you use to login to your online bank account to access your relevant payment accounts with your bank **(“Credentials”)**. 
    1.3	The Tool may allow you to use your Credentials to retrieve such Account Information as you choose to transmit to the Provider. Schedule 1 to the Terms of Service lists the information that you can elect to retrieve and transfer using the Tool.  
...
2. When determining the relevant retention periods, we consider factors including: 
    2.1	our contractual obligations and rights in relation to the information involved;
    2.2	legal obligation(s) under applicable law to retain data for a certain period of time;
    2.3	statute of limitations under applicable law(s);
    2.4	our legitimate interests where we have carried out balancing tests (see section on 'How we use your personal information' above);
    2.5	fraud and risk management;
    2.6	(potential) disputes; and
    2.7	guidelines issued by relevant data protection authorities.
...
2.\tWe may also disclose your Personal Data to other third parties in the event that: 
    2.1\tWe reasonably consider that we are under a duty to disclose or share your Personal Data in order to comply with any legal obligation; 
    2.2\tin order to enforce or apply our other agreements; or
    2.3\tto protect the rights, property, TrustLink’s safety, our customers, or others.
...
1.\tWhen you use our Services, you may provide us with your Credentials and we require your consent to use those Credentials to:
    1.1	\tretrieve your Account Information (including any Personal Data);
    1.2	\tto provide such Account Information to the Providers which referred you to us;
    1.3	\timprove the Services or the Tool;
    1.4	\ttemporarily access your payment account to debug any issues and to improve our automated processes for retrieving data.
...
4.\tCookies never store any of your banking details. We use the following types of cookies: 
    4.1 \t‘Session cookies’ which exist only while your browser is open. These cookies let us see where you’ve spent time on our Site and which part of the Site is the most or least effective. These are deleted automatically once you close your browser; and
    4.2 \t‘Persistent cookies’ which survive after your browser is closed. They can be used by the site to recognize your computer or mobile device when you open your browser and browse the Internet again.
    4.3 \t‘Third Party cookies’ these are cookies set by a domain other than our Site or a third party. These work by sharing your browser identification with that third party (like Facebook, Google), so that they can show you ads on their sites.
