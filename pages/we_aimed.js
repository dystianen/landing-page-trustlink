...
const we_aimed = () => {
  return (<>
      ...
      <div className="sm:ml-20 mt-80 sm:mt-20 lg:h-81 h-84 md:h-72 bg-[#04204D] text-white flex">
          ...
          <Image className="pt-80 2xl:pt-5 xl:pt-[46px] lg:pt-[119px] md:pt-[139px] " preview={false} src={"/assets/icon.png"}/>
          <div className="2xl:pl-10 2xl:py-10">
              <div className="px-10 pt-8 text-xl md:text-2xl lg:text-3xl 2xl:text-5xl">
              ...
              <div className="text-sm sm:pt-4 px-10 lg:text-lg md:text-sm py-8 2xl:text-2xl">
